  ...
  return (
    <div className="flex flex-col h-screen pt-10">
      ...
      <div className="flex justify-center">
        <form
          className="flex w-[90%] items-center px-5 gap-4 mb-[5rem] md:px-10 rounded-full bg-gray-200 dark:bg-gray-700 max-md:w-full"
        ...
        >
          ...
          <Input
            ...
            className="flex-1 rounded-lg px-4 py-8 bg-gray-200 dark:bg-gray-700 max-md:w-[80%] focus-visible:ring-transparent dark:focus-visible:ring-transparent"
            value={input}
