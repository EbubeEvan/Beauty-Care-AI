  ...
  return (
    <Card className='mt-10 mb-10 w-full max-w-2xl min-[1200px]:mt-16'>
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardHeader>
          <CardTitle className='mb-3 text-2xl'>Beauty Profile</CardTitle>
          <CardDescription>
            Please fill in the following information to the best of your knowledge. Feel free to
            click or type &quot;No idea&quot; if you don&apos;t know the answer.
          </CardDescription>
        </CardHeader>
